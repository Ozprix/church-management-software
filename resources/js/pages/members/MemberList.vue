<template>
  <div class="container mx-auto px-4 py-8">
    ...
    <!-- Members Table -->
    <div v-else-if="members.length > 0" class="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <td class="px-6 py-4 whitespace-nowrap">
              <div class="flex items-center">
                ...
                <div class="ml-4">
                  ...
                  <div v-if="member.family" class="text-sm text-gray-500">
                    {{ member.family.name }}
                  </div>
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...
    async deleteMember() {
      ...
      try {
        const response = await axios.delete(`/members/${this.memberToDelete.id}`);
        ...
        this.error = error.response?.data?.message || 'An error occurred while deleting the member';
      } finally {
        this.deleting = false;
      }
    }
